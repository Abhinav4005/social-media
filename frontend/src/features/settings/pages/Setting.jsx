                            ...
                            {activeTab === "preferences" && (
                                ...
                                >
                                    <PrefRow
                                        ...
                                        iconBg={isDark ? "bg-primary-50 dark:bg-primary-900/30 text-primary-400" : "bg-amber-50 dark:bg-amber-900/20 text-amber-500"}
                                        title="Dark Mode"
